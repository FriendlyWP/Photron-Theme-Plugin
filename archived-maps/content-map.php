  ...
  */
  ...
  $(document).ready(function(){
    ...
    $('.acf-map').each(function(){
      ...
      <span class="distrib-info"><h6>Address:</h6> <?php echo $location['address']; ?><a href="http://maps.google.com/maps?saddr=<?php echo $location['address'];?>" target="_blank" class="floatright button small directions-link">Get Directions</a></span>
